      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              <span className="text-[#1E2125] font-semibold text-lg sm:text-xl tracking-tight leading-tight group-hover:text-[#AC7B25] transition-colors duration-200">
                Shrishti Enterprises
              </span>
              <span className="text-[#6C6C6E] text-[11px] sm:text-xs font-normal tracking-wide uppercase">
          ...
          <div className="flex lg:hidden items-center gap-2.5">
            <a
              href={BUSINESS.phoneHref}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-[8px] text-white font-medium text-xs shadow-xs"
              style={{
                background: "linear-gradient(135deg, #AC7B25 0%, #C59740 100%)",
              }}
              aria-label={`Call ${BUSINESS.phoneDisplay}`}
            ...
            <button
              ...
              className="p-2.5 rounded-lg text-[#1E2125] hover:bg-gray-100 transition-colors focus:outline-hidden cursor-pointer"
              aria-label="Toggle navigation menu"
              aria-expanded={menuOpen}
            >
              <div className="w-5 h-5 flex flex-col justify-center gap-1.2 relative">
                <span
        ...
        <div
          className={`lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${
            menuOpen ? "max-h-[640px] opacity-100 border-t border-gray-100" : "max-h-0 opacity-0"
          }`}
        >
            ...
            <div className="pt-3 px-4 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <a
                  ...
                  className="min-h-[42px] flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-emerald-50 text-emerald-800 font-semibold text-sm border border-emerald-200 hover:bg-emerald-100 transition-colors"
                >
