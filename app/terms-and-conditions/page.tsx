      ...
      <section className="py-12 md:py-16 bg-gray-50/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-white p-6 sm:p-10 md:p-12 rounded-2xl shadow-sm border border-gray-200 prose prose-green md:prose-lg max-w-none text-gray-700">
            ...
            <div className="bg-green-50/80 border-l-4 border-green-600 p-4 rounded-r-xl mb-6">
              <p className="font-semibold text-green-900 mb-1">Written Warranty Guarantee:</p>
            ...
            <div className="bg-gray-900 text-white p-6 sm:p-8 rounded-2xl shadow-md border border-gray-800 not-prose">
              ...
              <div className="space-y-2.5 text-sm">
                <p>
                  ...
                  <a href={BUSINESS.phoneHref} className="text-green-400 font-bold hover:underline">
